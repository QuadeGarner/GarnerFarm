...
export default function AddAnimal(){
    ...
    cosnt handleStreetNameChange = (e) =>{
        ...
        <Container className = "mt-4">
            ...
            <Form onSubmit={handleSubmit}>
                <Form.Group className= "mb-3">
                    ...
                    <Form.Select value={formData.streetName}
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Select value= {formData.breed} onChange={handleBreedChange}
                    disabled={!selectedAnimal}
                    >
                        <option value="">Select breed</option>
                        {selectedAnimal?.breeds.map((b)=>(
                ...
                <Button type="submit" disabled={loading} className="w-100">
                    {loading?
                    (<>
                    <Spinner size="sm" className="me-2"/> Saving...</>):("Add Animal")}
                </Button>
            </Form>
        </Container>
    )
